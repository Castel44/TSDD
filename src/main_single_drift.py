...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='fin_phis')
    ...
    parser.add_argument('--drift_winsize', type=int, nargs='+', default=[50], help='Drift window size')
    parser.add_argument('--drift_counter', type=int, nargs='+', default=[10], help='Drift counter')
